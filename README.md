...
> :memo: **NOTE:** these are "playground projects" and should not be used in production until you've thoroughly tested their integration. I've provided over 98% test coverage, but as far as performance is concerned I doubt it'll stand up to any high load.

## Libraries

- **[Detached.OrleansContrib.Streaming.GrainStream](./src/Detached.OrleansContrib.Streaming.GrainStream/README.md)**: A simple orleans Stream provider using grains for persistence and delivery.
